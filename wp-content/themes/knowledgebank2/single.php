    ...
    <section>
        ...
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <?php if ($post->post_type == 'bibliography') : ?>

                        <section class="layer bibliography-note">
                            <div class="inner">
                                <h4>How can I get a copy of this title?</h4>
                                <p>We usually do not hold digital or physical copies of titles in our bibliography section. If we do offer a digital copy, there will be a link under 'Related records'. If we hold a physical copy in our reference library, HBKB will be listed under 'Holder'.</p>
                            </div>
                        </section>
