...
function knowledgebank_header_scripts() {
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        $js_mtime = filemtime(get_template_directory() . '/js/knowledgebank.js');
        ...
        //mark
        wp_register_script('mark', get_template_directory_uri() . '/js/lib/mark.js', array(), '1.0.0'); // Custom scripts
