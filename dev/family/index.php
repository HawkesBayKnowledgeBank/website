    ...
    <script>
        var json =
            ...
            */
            ...
            $pid = !empty($_GET['id']) ? $_GET['id'] : 33447; //JAMES WOODHOUSE BIBBY https://knowledgebank.org.nz/wp-admin/post.php?post=37606&action=edit
            $person = get_post($pid);
            ...
            function kb_get_relatives($pid) {
                ...
                foreach ($relations as $relative_type => $relatives) { //$relatives is an array, hopefully with an element named 'record' containing a WP_Post object
                    if (empty($relatives) || !is_array($relatives)) continue;
